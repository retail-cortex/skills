...
type CastorRepository struct{}

func NewCastorRepository() *CastorRepository {
	return &CastorRepository{}
}

// Deprecated: SkillsRepository is an alias for CastorRepository.
type SkillsRepository = CastorRepository

// Deprecated: NewSkillsRepository is an alias for NewCastorRepository.
func NewSkillsRepository() *CastorRepository {
	return NewCastorRepository()
}
...
func (r *CastorRepository) BuildSkillResponse(db *gorm.DB, skill *model.Skill, similarityScore *float64) (*model.SkillResponse, error) {
...
func (r *CastorRepository) CreateSkill(
	db *gorm.DB,
	appID string,
...
func (r *CastorRepository) GetSkill(db *gorm.DB, skillIDOrNameOrURI string) (*model.SkillResponse, error) {
	var skill model.Skill
...
func (r *CastorRepository) ListSkills(
	db *gorm.DB,
	query string,
	queryVector []float64,
...
func (r *CastorRepository) UpdateSkill(
	db *gorm.DB,
	skillID string,
	appID string,
...
func (r *CastorRepository) SaveSkillEmbeddings(
	db *gorm.DB,
	skillID string,
	embeddingChunks []model.SkillEmbeddingChunk,
) error {
...
func (r *CastorRepository) DeleteSkill(db *gorm.DB, skillID string, appID string) (map[string]interface{}, error) {
	var skill model.Skill
	if err := db.Where("id = ?", skillID).First(&skill).Error; err != nil {
		return nil, fmt.Errorf("%w: %s", ErrSkillNotFound, skillID)
	}
