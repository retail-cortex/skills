...
loader_src = project_root / "clients/python/src"
go_src = project_root / "examples/go/skills/src"
java_src = project_root / "examples/java/skills/src"
py_src = project_root / "examples/python/skills/src"

for src_path in [loader_src, go_src, java_src, py_src]:
